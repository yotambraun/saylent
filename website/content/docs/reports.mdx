...
A report from the app can also be published as a read-only link, exported as
CSV, JSON or the lossless run bundle, and its fixes tracked across every later
run: [Share, export and track fixes](/docs/sharing).
