...
requests, discussions, and any other project-run space), and also applies
...
reported by messaging the maintainer directly on GitHub, or by opening an
issue marked `confidential-request` without including details of the
incident in the issue itself - ask for a private follow-up channel there
instead. All complaints will be reviewed and investigated promptly and
fairly.
