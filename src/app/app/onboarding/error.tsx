"use client";
// Next 16 error boundary for /app/onboarding (Batch 1 safety net). Calm branded
// card; the back link points to / because onboarding is the pre-brand surface.
...
export default function OnboardingError({
  ...
  useEffect(() => {
    ...
    captureError(error, { boundary: "onboarding", digest: error.digest });
    console.error(error);
  }, [error]);
    ...
    <div className="mx-auto flex w-full max-w-md flex-col py-24">
      <Card>
        ...
        <CardContent className="flex flex-col gap-4 text-sm text-wire">
          <p>
            We couldn&apos;t load this step. Nothing you did. Try again, or head back and
