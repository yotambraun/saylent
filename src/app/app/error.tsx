"use client";
// Next 16 error boundary for /app (Batch 1 safety net). Renders a calm branded
// card instead of a white crash screen; Retry re-renders the segment via reset().
    ...
    <div className="mx-auto flex w-full max-w-md flex-col py-24">
      <Card>
        ...
        <CardContent className="flex flex-col gap-4 text-sm text-wire">
          <p>
            This page hit a snag on our side. Nothing you did. Your data and runs are
            safe.
          </p>
